...
22. DEV-120 siege snapshot/recovery: IMPLEMENTED, awaiting Windows quick-deploy and restart recovery verification. Snapshot schema is now v22; live Paper entities are intentionally excluded from persistence.
